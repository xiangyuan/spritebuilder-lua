...
$(call import-add-path, $(COCOS2DX_ROOT)/libpomelo)

LOCAL_SRC_FILES := hellolua/main.cpp \
../../Classes/VisibleRect.cpp \
../../Classes/AppDelegate.cpp \
../../Classes/ConfigParser.cpp \
$(COCOS2DX_ROOT)/quick/player/Classes/pomelobind/Lua_PomeloClient.cpp \
$(COCOS2DX_ROOT)/quick/player/Classes/pomelobind/PomeloClient.cpp \


ifeq ($(NDK_DEBUG),1)
$(info NDK_DEBUG is enabled!)
LOCAL_SRC_FILES += \
...
$(COCOS2DX_ROOT)/quick/player/Classes/pomelobind \
